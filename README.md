...
We tested our project's code via a testbench to test the behavior of the code.
...
2. The custom VGA letters were created off the basis of the VGA Tutorial provided by the course.
